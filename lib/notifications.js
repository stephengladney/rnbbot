      ...
      channel: () => {
        switch (currentStatus) {
          ...
          case "Ready for Code Review":
            return `${emojis.readyForReview} | ${emojis.jira} <https://salesloft.atlassian.net/browse/${cardNumber}|${cardNumber}> ${emojis.github} <${prUrl}|${prNumber}> | \`${truncatedTitle}\` is *ready for review* | ${atHere}`
